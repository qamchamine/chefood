...
const LoginProvider = ({ children }) => {
  ...
  return (
    <LoginContext.Provider value={{ isLoggedIn, login, logout, userData, setUserData, prod, setProd, loading, setLoading, formData, setFormData ,isLoggedFromOffers,setIsLoggedFromOffers,or,prodOrder, setProdOrder}}>
      {children}
