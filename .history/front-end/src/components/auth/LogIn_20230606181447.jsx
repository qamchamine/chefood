    ...
    <div className="FormRegister row">
      {isLoggedIn ? (
        ...
        <form
          ...
          className="pb-4 col-12 col-sm-12 col-md-6"
        >
          {error && <p>{error}</p>}
          <div className="mb-3">
          ...
          <div className="mb-3">
            ...
            <input
              type="password"
              className="form-control Spassword"
              id="password"
          ...
          <div className="bottonsingin">
            <div className="d-grid gap-3 mt-3">
              <button type="submit" className="btn btn-primary singinB">
                Log In
              </button>
          ...
          <div className="text-center mt-4 text-dark d-flex justify-content-end liensingup">
