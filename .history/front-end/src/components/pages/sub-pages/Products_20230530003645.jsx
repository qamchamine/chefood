...
/* setFormData({ ...formData, product_name: document.getElementById('buyingInput').value }) 
 */
...
/*     setFormData({ ...formData, product_name:  $('#buyingInput').value   });
 */
                ...
                <div className="d-grid ">
                  ...
                  <div className="row row-cols-1">
                    ...
                    <div className="input-group mb-3 d-flex justify-content-between gap-4">
                      <input type="text" className="form-control" value={formData.product_name}  onChange={handleChangeOrder} name='product_name'  id="buyingInput" />
                    ...
                    <div className="mb-3">
                      ...
                      <input type="text" name='full_name' value={formData.full_name} onChange={handleChangeOrder} className="form-control" id="full_name" placeholder='your full name ..' />
