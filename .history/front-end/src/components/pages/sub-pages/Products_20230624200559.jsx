                ...
                <div className="d-grid ">
                  ...
                  <div className="row row-cols-1">
                    ...
                    <div className="input-group mb-3 d-flex justify-content-between gap-4">
                      {/*  */}
                      <input type="hidden" className="form-control" value={formData.product_name} disabled  onChange={handleChangeOrder} name='                      <input type="hidden" className="form-control" value={formData.product_name} disabled  onChange={handleChangeOrder} name='product_name'  id="user_id" />
'  id="user_id" />
                      {/*  */}
