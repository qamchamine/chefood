                ...
                <div className="d-grid ">
                  ...
                  <div className="row row-cols-1">
                    ...
                    <div className="mb-3">
                      ...
                      <input type="text" name='full_name' disabled={isÖ} value={isLoggedIn?userData.firstname+' '+userData.lastname:formData.full_name} onChange={handleChangeOrder} className="form-control" id="full_name" placeholder='your full name ..' />
