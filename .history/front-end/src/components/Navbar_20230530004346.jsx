    ...
    return (
        ...
        >
            <nav className="navbar  navbar-expand-md d-flex justify-content-between navbar-dark ">
                <span className="navbar-brand">CheFood</span>
                ...
                <div className="collapse navbar-collapse justify-content-around" id="navbarNav">
                    <ul className="navbar-nav nav gap-1 ps-4 ps-md-0 justify-content-center w-100">
                        ...
                        <li className="nav-item dropdown" >
                            ...
                            <ul className="dropdown-menu">
                                ...
                                <li>
                                    <NavLink className="dropdown-item" to="/services/online-ordering">
                                        Online Ordering
                                    </NavLink>
                                </li>
                                <li>
                    ...
                    {isLoggedIn ?
                        <div className="btn-group me-4 d-flex align-items-center">
                            <button data-bs-toggle="dropdown" className="text-light btn">{userData.firstname}</button>
                            <span data-bs-toggle="dropdown" style={{background : userData.admin? 'var(--bs-success)':'#d18343'} }  className="profile-two-letters text-uppercase"> {userData.firstname.charAt(0) +  userData.lastname.charAt(0)} </span>
{/*                             <button type="button" className="btn text-light dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" >
                            </button> */}
                        ...
                        :
                        <NavLink to="/login" className="signUP me-4 btn btn-danger float-end rounded-pill px-4" style={{ filter: "contrast(90%) brightness(140%)", width: '11em' }} > LOGIN </NavLink>}
