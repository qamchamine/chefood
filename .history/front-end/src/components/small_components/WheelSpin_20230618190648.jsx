...
<div id="myModal" class="modal ">
	<div class="modal-dialog position-relative modal-confirm">
		<div class="modal-content ">
			...
			<div class="modal-footer justify-content-center flex-column gap-1">
				<button type="button" class="btn w-50 btn-secondary" data-bs-dismiss="modal">Register</button>
				<button type="button" class="btn w-50 btn-danger">Log In</button>
			</div>
		</div>
	</div>
</div>     
