...
<div id="myModal" class="modal ">
	<div class="modal-dialog position-relative modal-confirm">
        ...
        <Link to='/login'><button type="button" class="btn w-25 px-4 ">Log In</button></Link>
        <Link to='/register'><button type="button" class="btn w-25  btn-secondary" data-bs-dismiss="modal">Register</button></Link>
