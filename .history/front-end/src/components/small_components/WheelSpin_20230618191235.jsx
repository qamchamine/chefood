	...
	<div class="modal-dialog position-relative modal-confirm">
		<div class="modal-content ">
			...
			<div class="modal-footer justify-content-center gap-4">
				<button type="button" class="btn w-25  btn-secondary" data-bs-dismiss="modal">Register</button>
				<button type="button" class="btn w-25 px-4 btn-outline-succer">Log In</button>
			</div>
		</div>
	</div>
</div>     
