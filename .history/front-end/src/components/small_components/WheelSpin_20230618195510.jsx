 ...
 */          });
  ...
  return (
	...
	<button  class={`spin ${isLoggedIn?'':'d-none'} ` } >SPIN</button>
  {isLoggedIn?'':<button  class="trigger-btn spin" data-bs-toggle="modal" data-bs-target="#myModal">SPIN</button>}
	
</div>

<div id="myModal" class="modal ">
	<div class="modal-dialog position-relative modal-confirm">
		<div class="modal-content ">
			<div class="modal-header flex-column">
                <button type="button" class="btn-close " style={{translate:'80% -80%'}} data-bs-dismiss="modal" ></button>
				<div class="icon-box">
					<i class="material-icons">warning</i>
				</div>						
				<h4 class="modal-title w-100 ">You need to login first !</h4>	
			</div>
        ...
        <Link to='/register' class="btn w-25 btn-secondary" 
        >Register</Link>
				
        <Link to='/login' class="btn w-25 px-4 ">Login</Link>
			</div>
		</div>
	</div>
</div>     
