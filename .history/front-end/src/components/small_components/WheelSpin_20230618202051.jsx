...
var handleOffersToAuth = ()=>{ 
  setIsLoggedFromOffers(true)
  $(function(){
    $('#offersModalClose').click()
  })
  alert(isLoggedFromOffers)
}
	...
	<div className="modal-dialog position-relative modal-confirm">
		<div className="modal-content ">
			<div className="modal-header flex-column">
                <button type="button" className="btn-close " id='offersModalClose'} style={{translate:'80% -80%'}} data-bs-dismiss="modal" ></button>
        ...
        <Link onClick={handleOffersToAuth} to='/register' className="btn w-25 btn-secondary" 
        >Register</Link>
