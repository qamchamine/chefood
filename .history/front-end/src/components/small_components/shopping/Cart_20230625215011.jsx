                            ...
                            <tbody>
                                {isLoggedIn ? orders.map((item, i) => (
                                    <tr key={i}>
                                        ...
                                        <td>
                                            <i
                                                className="bi bi-x fs-1 fw-bold text-danger"
                                ...
                                <tr className='cart-footer'>
                                    <th colSpan={4} className="text-start ps-5 text-light" style={{ background: '#982727' }}>
                                        Total
                                    </th>
                                    <th style={{ background: '#982727' }} colSpan={3} className=" py-3 text-light">
                                        <span style={{ background: '#982727aa', fontSize: '.9em' }} className="badge text-start p-1 rounded-pill shadow-sm pe-3"
                                        >{orders.reduce((acc, item) => acc += item.product_quantity * prod.find((el, i) => el.id === item.product_id).price, 0).toFixed(2)} MAD
                                        </span>
                                    </th>
                                </tr>
                            </tbody>
