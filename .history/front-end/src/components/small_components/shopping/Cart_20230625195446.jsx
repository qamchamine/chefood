            ...
            <div className="col-md-12">
                <div className="card">
                    <div className="card-body">
                        <table className="table ajouterPanierTable table-bordered">
                            <thead >
                                <tr>
                                    <th >#</th>
                                    <th >Image</th>
                ...
                {/*                             <img src={require(`../../../images/products/${prod.find(el=>el.id==item.product_id).category} (${prod.find((el,i)=>el.id===item.product_id).img}).png`)} alt={item.product_name} 
                            ...
                            <tr>
                                ...
                                <th colSpan={4} className=" bg-dark pe-5 py-3">
                                    <span className="badge bg-danger float-end p-2 text-end rounded-pill ">
                                        $
                                        {
