                    ...
                    <div className="card-body">
                        <table className="table">
                            ...
                            <tbody>
                            {
                                orders.map((item,i) => (
                                    <tr key={item.id}>
{                                        console.log(prod.find(el=>el.id===item.product_id))
}                                        <th scope="row">{item.id}</th>
                                        <td>
                                            <img src={require(`../../../images/products/${prod.find(el=>el.id===item.product_id).img} (${prod.find(el=>el.id===item.product_id).img}).png`)} alt={item.product_name} 
