  ...
  console.log(userOrders);
    ...
    return (
        <div className="row my-4 cart-page">
            <h2 className='text-center'>Orders</h1>
            <div className="col-md-12">
                <div className="card">
                    <div className="card-body">
                        <table className="table table-hover table-striped ajouterPanierTable table-bordered">
                            <thead >
                                <tr>
                                    <th >#</th>
                                    <th >Image</th>
                ...
                {/*                             <img src={require(`../../../images/products/${prod.find(el=>el.id==item.product_id).category} (${prod.find((el,i)=>el.id===item.product_id).img}).png`)} alt={item.product_name} 
                                       ...
                                       <td>{(item.product_quantity * prod.find((el,i)=>el.id===item.product_id).price).toFixed(2)} MAD</td>
                                        <td>
                                            <i 
                            ...
                            <tr>
                                ...
                                <th colSpan={1} className=" b py-3">
                                    <span style={{background:'#982727'}} className="badge text-center p-2 rounded-pill ">
                                        $
                                        {
