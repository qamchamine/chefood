 ...
 */          });
  ...
  return (
	...
	<button  class="trigger-btn" style={{zIndex:'10000'}} data-bs-toggle="modal" data-bs-target="#myModal">SPIN</button>
</div>
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-center">
				<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Re</button>
