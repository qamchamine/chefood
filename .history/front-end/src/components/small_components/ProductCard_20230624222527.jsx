...
useEffect(()=>{
  $(function(){
    ...
    setFormData({...formData , product_name:$(this).parents('.product-card').find('h4').text(),full_name:isLoggedIn?userData.firstname+' '+userData.lastname:'' ,user_id:userData.id  ,product_id:prodprod.id })
